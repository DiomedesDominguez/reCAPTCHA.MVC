...
namespace DNMOFT.reCAPTCHA.MVC
{
    internal class RecaptchaValidator
    {
        ...
        public RecaptchaResponse Validate()
        {
            ...
            var bytes = Encoding.ASCII.GetBytes($"secret={HttpUtility.UrlEncode(PrivateKey)}&response={HttpUtility.UrlEncode(Response)}&remoteip={HttpUtility.UrlEncode(RemoteIP)}");
